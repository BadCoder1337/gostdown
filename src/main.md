...
при желании нарушать пропорции, задавая явно высоту](./src/assets/drracket-screenshot.png){#fig:myfigure1 width=415px}
...
JPEG (и PNG) в таком случае растягиваются на всю ширину страницы](./src/assets/lunokhod-expo.jpg){#fig:myfigure2}
...
![Изображение в формате EMF размером 15 на 6 см](./src/assets/oc-plot.emf){#fig:myfigure3 width=15cm height=6cm type="image/emf"}
...
:::{custom-style="Figure"}
![](./src/assets/iaa-logo.emf){width=1.1in height=1in type="image/emf"}
:::
